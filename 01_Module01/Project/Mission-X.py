...
print("Consumed\t\t:", (earth_moon_distance - (earth_moon_distance - ((current_date - launch_date)*24)*craft_speed))/craft_mileage, "Liters")
print("Remaining\t\t:", craft_fuel_capacity - ((earth_moon_distance - (earth_moon_distance - ((current_date - launch_date)*24)*craft_speed))/craft_mileage), "Liters")
