...
print("Distance Left\t\t:", (earth_moon_distance - ((current_date - launch_date)*24)/craft_mileage), "kilometers") 
print("Travel Time\t\t:", earth_moon_distance/craft_speed, "Hours")
print("Elapsed Time\t\t:", (current_date - launch_date)*24, "Hours")
print("ETA\t\t\t:", ((earth_moon_distance - ((current_date - launch_date)*24)/craft_mileage)/craft_speed), "Hours")

print("\nFUEL STATUS")
print("Capacity\t\t:", craft_fuel_capacity, "Liters")
print("Consumed\t\t:", (((current_date - launch_date)*24)/craft_mileage)*craft_mileage, "Liters")
print("Remaining\t\t:", craft_fuel_capacity - ((((current_date - launch_date)*24)/craft_mileage)*craft_mileage), "Liters")
